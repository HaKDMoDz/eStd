...
namespace System.Contracts
{
    ...
    /// <see>
    ///   <cref>Condition.WithExceptionOnFailure{TException}</cref>
    /// </see>  method overloads and allow you to specify
    /// the exception type that should be thrown on failure.
    /// </summary>
    public abstract class AlternativeExceptionContract
    {
        /// <summary>
        ...
        /// </example>
        public abstract ContractValidator<T> Requires<T>(T value);
        ...
        /// See the <see cref="ContractValidator{T}"/> class for more code examples.
        /// </example>
        public abstract ContractValidator<T> Requires<T>(T value, string argumentName);
