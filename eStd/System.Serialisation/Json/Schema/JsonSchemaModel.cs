...
namespace System.Serialisation.Json.Schema
{
    ...
    internal class JsonSchemaModel
    {
        ...
        private static void Combine(JsonSchemaModel model, JsonSchema schema)
        {
            ...
            {
                if (model.Enum == null)
                    model.Enum = new List<System.Serialisation.Json.Linq.JToken>();

                model.Enum.AddRangeDistinct(schema.Enum, System.Serialisation.Json.Linq.JToken.EqualityComparer);
            }
