...
namespace System.Serialisation.Advanced
{
    ...
    public sealed class XmlPropertyDeserializer : IPropertyDeserializer
    {
        ...
        {
            // ElementType
            property.ElementType = property.Type != null ? System.Serialisation.Serializing.TypeInfo.GetTypeInfo(property.Type).ElementType : null;
        ...
        private void parseDictionaryProperty(DictionaryProperty property)
        {
            ...
            {
                var typeInfo = System.Serialisation.Serializing.TypeInfo.GetTypeInfo(property.Type);
