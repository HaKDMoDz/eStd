namespace System.Runtime.Dynamic
{
    ...
    public class DynamicDllImportMetaObject : DynamicMetaObject
    {
        ...
        {
            Type returnType = this.GetMethodReturnType(binder);
    ...
    public class DynamicDllImport : DynamicObject
    {
        ...
        public MethodInfo GetInvokeMethod(string methodName, Type returnType, Type[] types)
        {
            ...
            if (this.assemblyBuilder == null)
            {
                ...
                this.moduleBuilder = this.assemblyBuilder.DefineDynamicModule(this.AssemblyName);
            }

            var defineType = this.moduleBuilder.DefineType(this.GetDefineTypeName(methodName));
            var methodBuilder = defineType.DefinePInvokeMethod(methodName, this.dllName, entryName,
                       MethodAttributes.Public | MethodAttributes.Static | MethodAttributes.PinvokeImpl,
                       CallingConventions.Standard,
                       returnType, types,
                       this.CallingConvention, this.CharSet);
