...
namespace System.IO
{
        ...
        where Value : ICacheable
    {
        ...
        /// </summary>
        private Queue<Key> arrivalOrder;

        /// <summary>
        /// The private container representing the cache.
        /// </summary>
        private Dictionary<Key, Value> cacheStore;
        ...
        public void Add(Key k, Value v)
        {
            ...
            {
                Debug.WriteLine(string.Format("Need to make space for {0} bytes, currently using {1}", v.BytesUsed,
                                              CurrentCacheUsage));
